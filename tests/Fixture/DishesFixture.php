...
class DishesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_dishes_categories_idx' => ['type' => 'index', 'columns' => ['categories_id'], 'length' => []],
            'fk_dishes_subcategories1_idx' => ['type' => 'index', 'columns' => ['subcategories_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_dishes_categories' => ['type' => 'foreign', 'columns' => ['categories_id'], 'references' => ['categories', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_dishes_subcategories1' => ['type' => 'foreign', 'columns' => ['subcategories_id'], 'references' => ['subcategories', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',

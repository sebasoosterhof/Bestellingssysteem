...
INSERT INTO `reservations` (`id`, `reservation_date`, `reservation_time`, `persons`, `lastname`, `email`, `telephonenumber`, `copmany_name`, `dish_id`, `created`, `modified`) VALUES
...
--
ALTER TABLE `reservations`
  ADD CONSTRAINT `reservations` FOREIGN KEY (`dish_id`) REFERENCES `dishes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
